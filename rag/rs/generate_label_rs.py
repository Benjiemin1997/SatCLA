...
def generate_tags_for_dataset(knowledge_base):
    ...
    for idx, item in enumerate(knowledge_base):
        ...
        prompt = build_prompt(best_match_description, '../rag/rs/label.json')
...
if __name__ == "__main__":
    ...
    os.makedirs("../result/rs/first_tag", exist_ok=True)
    with open("../result/rs/first_tag/first_tag_qwen_rs.json", "w", encoding="utf-8") as f:
